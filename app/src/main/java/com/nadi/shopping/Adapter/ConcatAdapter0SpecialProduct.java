...
public class ConcatAdapter0SpecialProduct extends RecyclerView.Adapter<ConcatAdapter0SpecialProduct.MyViewHolder> {

    Context context;
    List<Item0AmazingOfferModel> data;

    public ConcatAdapter0SpecialProduct(Context context, List<Item0AmazingOfferModel> data) {
     ...
     //   TextView  stock_TV;
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
             ...
             txtNameAmazingOffer_TV = itemView.findViewById(R.id.txtNameAmazingGoods_item0AmazingOfferHomeFragment);
             imgAmazingOffer_IV = itemView.findViewById(R.id.imgAmazingGoods_item0AmazingOfferHomeFragment);
