...
public class AdapterAllDetailDetailCategory extends RecyclerView.Adapter<AdapterAllDetailDetailCategory.MyViewHolder> {

     Context context;
     List<Item0AmazingOfferModel> data;

    public AdapterAllDetailDetailCategory(Context context, List<Item0AmazingOfferModel> data) {
